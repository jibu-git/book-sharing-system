...
public interface SysUserMapper
{
    ...
    /**
     * 数据库原子操作：为指定用户增加/累计可用积分余额
     * @param userId 用户ID
     * @param amount 增加的积分数量
     */
    public int updateUserPointsBalance(@Param("userId") Long userId, @Param("amount") Integer amount);

    // 添加冻结积分
    public int updateUserPointsFrozen(@Param("userId") Long userId, @Param("amount") Integer amount);
}
